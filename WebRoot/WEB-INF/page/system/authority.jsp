...
<body>
	...
	<!-- 遮罩层 -->
	<div id="userRightsMasklayer">
	</div>

	<!-- 显示已有的权限 -->
	<s:iterator value="#request.userList" var="userRights">
		<div class="panel panel-default">
			<div class="panel-heading">权限等级<s:property value="#userRights.rightId" />
	  		</div>
	  		<div class="panel-body">
    			<div class="checkbox">
    				<s:if test="#userRights.dataAcquisition==1">
    					<label>
		    		      <input type="checkbox" checked> 数据采集分析处理&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
		    		      <input type="checkbox"> 数据采集分析处理&nbsp;&nbsp;
		    		    </label>
    				</s:else>
    				<s:if test="#userRights.coordinatedDispatch==1">
    					<label>
		    		      <input type="checkbox" checked> 协调调度&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
		    		      <input type="checkbox"> 协调调度&nbsp;&nbsp;
		    		    </label>
    				</s:else>
    				...
    				<s:if test="#userRights.serviceOperation==1">
    					<label>
		    		      <input type="checkbox" checked> 业务运营&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
		    		      <input type="checkbox"> 业务运营&nbsp;&nbsp;
		    		    </label>
    				</s:else>
    				<s:if test="#userRights.customerService==1">
    					<label>
		    		      <input type="checkbox" checked> 客户服务系&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
		    		      <input type="checkbox"> 客户服务系&nbsp;&nbsp;
		    		    </label>
    				</s:else>
    				<s:if test="#userRights.comprehensiveOffice==1">
    					<label>
		    		      <input type="checkbox" checked> 综合办公&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
		    		      <input type="checkbox"> 综合办公&nbsp;&nbsp;
		    		    </label>
    				</s:else>
    				<s:if test="#userRights.wanSystem==1">
    					<label>
		    		      <input type="checkbox" checked> 广域网管理&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
    				...
    				<s:if test="#userRights.websiteSystem==1">
    					<label>
		    		      <input type="checkbox" checked> 网站系统管理&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
    				...
    				<s:if test="#userRights.mailSystem==1">
    					<label>
		    		      <input type="checkbox" checked> 邮件系统管理&nbsp;&nbsp;
		    		    </label>
    				</s:if>
    				<s:else>
    					<label>
	...
	<button type="button" class="btn btn-primary btn-sm" style="float: left; margin-top: -5px;" onclick="openRightAddDialog()">添加新的权限</button>
	...
	<div id="addRights">
		...
		<form id="userRightForm" action="userRightAction_add.action">
			...
			<br/>
			<label>
				<input type="checkbox" name="dataAcquisition"> 数据采集分析处理&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="coordinatedDispatch"> 协调调度    &nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="unifiedDatabase"> 统一信息库&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="applicationShow"> 应用展示&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="serviceOperation"> 业务运营&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="customerService"> 客户服务系&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="comprehensiveOffice"> 综合办公&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="wanSystem"> 广域网管理&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="websiteSystem"> 网站系统管理&nbsp;&nbsp;
			</label>
			<label>
				<input type="checkbox" name="mailSystem"> 邮件系统管理&nbsp;&nbsp;
			</label>
			<br>
			<input type="reset" value="重置" class="rightsDialogButton" />
